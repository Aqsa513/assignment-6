# 1. Using self
# Assignment:
# Create a class Student with attributes name and marks. Use the self keyword to initialize these values via a constructor. Add a method display() that prints student detail.
...
student:Student = Student("Aqsa",92)
print(student.name)
print(student.marks)
...
emp1 : Employee = Employee("Aqsa", 50000, "123-45-6789")
print(emp1.name)    
print(emp1._salary)
# ❌ This will cause an AttributeError
# print(emp1.__ssn) 
print(emp1._Employee__ssn) # Accessing private variable using name mangling
...
teaccher: Teacher = Teacher("Aqsa", "Mathmatics")
print(f' Name:{teaccher.name} Subject:{teaccher.subject}.') 
...
rect1 : Rectangle = Rectangle(5.8,10.2)
...
employee1 : Employee = Employee("Aqsa", department)
print(f'Employee {employee1.employee_name} work in {employee1.department.get_department_name()}')
